...
namespace AssemblyBrowserLib.Format
{
    public static class MethodFormatter
    {
        ...
        {
            return string.Join(" ", GetTypeAccessorModifiers(methodInfo), GetTypeModifiers(methodInfo), GetType(methodInfo), methodInfo.Name, GetMethodArguments(methodInfo));
        }
        ...
        private static string GetType(MethodInfo methodInfo)
        {
